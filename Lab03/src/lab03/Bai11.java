...
///////////////////////////  
Bai11(String frameText)//constructor  
{  
super(frameText);  
...
{  
new Bai11("Calculator - JavaTpoint");  
}  
}  
...
//////////////////////////////////////////  
MyDigitButton(int x,int y, int width,int height,String cap, Bai11 clc)  
{  
super(cap);  
...
MyOperatorButton(int x,int y, int width,int height,String cap, Bai11 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
...
if(opText.equals("1/x"))  
    ...
    try  
        ...
        cl.displayLabel.setText(Bai11.getFormattedText(tempd));}  
...
case 'R':   
    cl.displayLabel.setText(Bai11.getFormattedText(cl.memValue));break;  
case 'S':  
    cl.memValue=0.0;  
case '+':   
...
MySpecialButton(int x,int y, int width,int height,String cap, Bai11 clc)  
{  
super(cap);  
setBounds(x,y,width,height);  
this.cl=clc;  
